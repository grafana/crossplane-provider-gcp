...
type RegionInstanceGroupManagerInitParameters struct {
	...
	Params []RegionInstanceGroupManagerParamsInitParameters `json:"params,omitempty" tf:"params,omitempty"`
...
type RegionInstanceGroupManagerParamsInitParameters struct {
