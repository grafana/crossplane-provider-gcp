...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CircuitBreakersConnectTimeoutInitParameters) DeepCopyInto(out *CircuitBreakersConnectTimeoutInitParameters) {
	*out = *in
	if in.Nanos != nil {
		in, out := &in.Nanos, &out.Nanos
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CircuitBreakersConnectTimeoutInitParameters.
func (in *CircuitBreakersConnectTimeoutInitParameters) DeepCopy() *CircuitBreakersConnectTimeoutInitParameters {
	if in == nil {
		return nil
	}
	out := new(CircuitBreakersConnectTimeoutInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CircuitBreakersInitParameters) DeepCopyInto(out *CircuitBreakersInitParameters) {
	*out = *in
	if in.ConnectTimeout != nil {
		...
		*out = make([]ConnectTimeoutInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RegionBackendServiceCircuitBreakersInitParameters) DeepCopyInto(out *RegionBackendServiceCircuitBreakersInitParameters) {
	*out = *in
	if in.ConnectTimeout != nil {
		in, out := &in.ConnectTimeout, &out.ConnectTimeout
		*out = make([]CircuitBreakersConnectTimeoutInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RegionBackendServiceInitParameters) DeepCopyInto(out *RegionBackendServiceInitParameters) {
	*out = *in
	...
	if in.ConnectionTrackingPolicy != nil {
		...
		*out = make([]ConnectionTrackingPolicyInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Subsetting != nil {
		...
		*out = make([]SubsettingInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RegionInstanceGroupManagerInitParameters) DeepCopyInto(out *RegionInstanceGroupManagerInitParameters) {
	*out = *in
	...
	if in.Params != nil {
		in, out := &in.Params, &out.Params
		*out = make([]RegionInstanceGroupManagerParamsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RegionInstanceGroupManagerParamsInitParameters) DeepCopyInto(out *RegionInstanceGroupManagerParamsInitParameters) {
	*out = *in
	if in.ResourceManagerTags != nil {
		in, out := &in.ResourceManagerTags, &out.ResourceManagerTags
		*out = make(map[string]*string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RegionInstanceGroupManagerParamsInitParameters.
func (in *RegionInstanceGroupManagerParamsInitParameters) DeepCopy() *RegionInstanceGroupManagerParamsInitParameters {
	if in == nil {
		return nil
	}
	out := new(RegionInstanceGroupManagerParamsInitParameters)
	in.DeepCopyInto(out)
	return out
}
