...
// GetTerraformResourceType returns Terraform resource type for this StorageHMACKey
func (mg *StorageHMACKey) GetTerraformResourceType() string {
	return "google_storage_hmac_key"
}

// GetConnectionDetailsMapping for this StorageHMACKey
func (tr *StorageHMACKey) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"secret": "status.atProvider.secret"}
}

// GetObservation of this StorageHMACKey
func (tr *StorageHMACKey) GetObservation() (map[string]any, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this StorageHMACKey
func (tr *StorageHMACKey) SetObservation(obs map[string]any) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this StorageHMACKey
func (tr *StorageHMACKey) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this StorageHMACKey
func (tr *StorageHMACKey) GetParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this StorageHMACKey
func (tr *StorageHMACKey) SetParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this StorageHMACKey using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *StorageHMACKey) LateInitialize(attrs []byte) (bool, error) {
	params := &StorageHMACKeyParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *StorageHMACKey) GetTerraformSchemaVersion() int {
	return 0
}
